...
{ int floor ;
 ...
 tmp___4 = areDoorsOpen();
  if ((floor == 0) && (landingButtons_spc1_0 == 1) && (tmp___4==1)) {
        landingButtons_spc1_0 = 0;
  } else {
	tmp___3 = areDoorsOpen(); 
    if ((floor == 1) && (landingButtons_spc1_1 == 1) && (tmp___3==1)) {
          landingButtons_spc1_1 = 0;
    } else {
	  tmp___2 = areDoorsOpen(); 
      if ((floor == 2) && (landingButtons_spc1_2 == 1) && (tmp___2==1)) {
            landingButtons_spc1_2 = 0;
      } else {
		tmp___1 = areDoorsOpen();
        if ((floor == 3) && (landingButtons_spc1_3 == 1) && (tmp___1==1)) {
              landingButtons_spc1_3 = 0;
        } else {
		  tmp___0 = areDoorsOpen();
          if ((floor == 4) && (landingButtons_spc1_4 == 1) && (tmp___0==1)) {
                landingButtons_spc1_4 = 0;
              } 
        }
      }
...
void __utac_acc__Specification1_spec__4(void) { 
  ...
  if (landingButtons_spc1_0==1) {
    assert(0);
  } else {
    if (landingButtons_spc1_1==1) {
      assert(0);
    } else {
      if (landingButtons_spc1_2==1) {
        assert(0);
      } else {
        if (landingButtons_spc1_3==1) {
          assert(0);
        } else {
          if (landingButtons_spc1_4==1) {
            assert(0);
          } 
        }
      }
...
{ int retValue_acc ;
  ...
  if (__SELECTED_FEATURE_overloaded==1) {
...
{ 
  ...
  if (__SELECTED_FEATURE_weight==1) {

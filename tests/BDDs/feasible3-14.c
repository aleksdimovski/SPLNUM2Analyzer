...
int main() {
  ...
  #if (A8) i=i+1; #else i=0; #endif
  #if (A9) i=i+1; #else i=0; #endif
  #if (A10) i=i+1; #else i=0; #endif
  #if (A11) i=i+1; #else i=0; #endif
  #if (A12) i=i+1; #else i=0; #endif
  #if (A13) i=i+1; #else i=0; #endif
  #if (A14) i=i+1; #else i=0; #endif	
